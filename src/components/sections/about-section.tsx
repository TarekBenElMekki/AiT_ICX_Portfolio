    ...
    <section id="about" className="relative overflow-hidden py-14 md:py-16">
      ...
      <div className="section-shell relative z-10 grid gap-6 xl:grid-cols-[1.8fr_0.78fr]">
        <div className="soft-card p-6 md:p-8 xl:p-10">
          ...
          <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-slate-800 md:text-5xl">
            AIESEC in Tunisia
          </h2>

          <p className="mt-5 text-base leading-8 text-slate-600 md:text-lg md:leading-9">
            AIESEC is structured into national entities, each representing a country.
          </p>

          <p className="mt-5 max-w-4xl text-lg leading-8 text-slate-700 md:text-[1.2rem] md:leading-9">
            We are proudly part of <span className="font-bold text-slate-900">AIESEC in Tunisia</span>, one of the
            <span className="font-bold text-slate-900"> most vibrant entities in the global network</span>,
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
          {stats.map((item) => (
            ...
            >
              <div className="text-3xl font-extrabold text-slate-800 md:text-5xl">{item.value}</div>
